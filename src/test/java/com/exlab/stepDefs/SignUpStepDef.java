...
public class SignUpStepDef {
    ...
    public void the_user_verifies_that_name_as_and_email_as(String expectedName, String expectedEmail) {
        ...
        assertEquals(expectedEmail,ExlabRequest.response.path("email[0]"));
    }
    ...
    public void the_user_creates_a_POST_request_for_add_a_new_experience_with_and_and_and_and_and_and(String job,String company,String location,String fromdate, String todate,
